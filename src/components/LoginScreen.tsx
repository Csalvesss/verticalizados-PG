...
// No iOS standalone (PWA adicionado à tela de início), o WebView é isolado:
// não compartilha cookies/sessão com o Safari, então nenhum OAuth de terceiro
// funciona — o Google sempre mostra a tela sem contas salvas.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Google button — desabilitado no iOS standalone */}
        {iosStandalone ? (
          <div style={{
            ...
            <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#F07830" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
              <circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/>
            </svg>
            <p style={{
              fontFamily: 'Barlow, sans-serif', fontSize: 12,
              color: '#71767b', margin: 0, lineHeight: 1.5,
            }}>
              Login com Google não está disponível no app instalado.{' '}
              <span style={{ color: '#e7e9ea' }}>Use e-mail e senha</span>
              {' '}ou entre pelo{' '}
              <span
                onClick={() => window.open('https://verticalizados-pg.netlify.app', '_blank')}
                style={{ color: '#F07830', cursor: 'pointer', textDecoration: 'underline' }}
              >
                Safari
              </span>
              {' '}para usar o Google.

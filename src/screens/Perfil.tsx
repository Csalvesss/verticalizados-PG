        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
              <div style={{ width: 72, height: 72, borderRadius: '50%', padding: 3, background: 'linear-gradient(135deg, #F07830, #D4621A)' }}>
                <img
                  src={editPhoto || currentUser.photo}
                  alt=""
                  onError={(e) => { (e.target as HTMLImageElement).src = currentUser.photo; }}
                  style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover', border: '2px solid #111', display: 'block' }}
                />
              </div>
            </div>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: 'Barlow', fontSize: 12, color: '#666', marginBottom: 6 }}>
                URL da foto <span style={{ color: '#444' }}>(opcional)</span>
              </div>
              <input
                value={editPhoto}
                ...
                style={{
                  width: '100%', background: '#1a1a1a', border: '1px solid #2f3336',
                  borderRadius: 10, padding: '10px 14px', fontFamily: 'Barlow',
                  fontSize: 13, color: '#aaa', outline: 'none', boxSizing: 'border-box',
                }}
              />
              <div style={{ fontFamily: 'Barlow', fontSize: 11, color: '#444', marginTop: 6 }}>
                Deixe em branco para manter a foto do Google
              </div>
            </div>

            {saveError && (
              <div style={{ fontFamily: 'Barlow', fontSize: 12, color: '#f4212e', marginBottom: 12 }}>
                {saveError}
              </div>
            )}
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                ...
                style={{
                  ...
                  color: '#888', borderRadius: 50, padding: '12px',
              ...
              <button
                ...
                style={{
                  flex: 2,
                  background: editName.trim() ? '#F07830' : '#2a1a0a',
                  border: 'none',
                  color: editName.trim() ? '#fff' : '#7a5a3a',
                  borderRadius: 50, padding: '12px',
                  fontFamily: 'Barlow Condensed', fontWeight: 700,
                  fontSize: 13, cursor: saving ? 'default' : 'pointer', letterSpacing: 1,
                }}
              >

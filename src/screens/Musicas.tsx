...
function SongCard({
  ...
  return (
    <div style={s.card}>
      ...
      {open && (
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '20px 16px 4px', background: 'rgba(255,255,255,0.02)' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.03)', padding: '12px 16px', display: 'flex', gap: 12, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        {song.spotify && (
...
export function MusicasScreen({
  ...
  const tabStyle = (active: boolean) => ({
    ...
    background: active ? 'linear-gradient(135deg, #F07830 0%, #BA7517 100%)' : 'rgba(18,20,25,0.8)',
